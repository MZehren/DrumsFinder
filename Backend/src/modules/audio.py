...
def visualizeSpectrogram(spectrogram=None, midi=None, samplingRate=44100, frameDuration=0.075):
    fig = plt.figure()
    ...
    if spectrogram:
        ...
        cax = ax.imshow(points, extent=extent,  cmap="nipy_spectral", aspect="auto") #todo: Image data can not convert to float. I don't understand this error.
        fig.colorbar(cax)
